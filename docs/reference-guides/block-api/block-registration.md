...
**Note:** Custom SVG icons are automatically wrapped in the [`wp.primitives.SVG` component](/packages/primitives/) to add accessibility attributes (`aria-hidden`, `role`, and `focusable`).
